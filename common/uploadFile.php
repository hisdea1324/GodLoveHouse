...
function choice() {
	...
	if (opener.document.getElementById("file<?php echo $tagName;?>") != null) {
		opener.document.getElementById("file<?php echo $tagName;?>").src = "/upload/<?php echo $pathName;?>/<?php echo $attach->Name;?>";
	}
...
function checkFile() {
	...
	document.getElementById("frmUploadFile").action="uploadFile.php";
