...
$mListHelper = new MemberHelper();
//페이징 갯수 
$mListHelper->PAGE_COUNT=15;
$mListHelper->PAGE_UNIT=10;
$mListHelper->setOrder($order);
if ((strlen($keyword)>0)) {
	$mListHelper->setCondition($userLv, $field, $keyword);
} 


$members = $mListHelper->getMemberList($page);
$strPage = $mListHelper->makePagingHTML($page);
...
$htmlTable = $objTable->getTable($members);
