...
// if (!needUserLv(9) && (isset($_SESSION["userid"]) && $_SESSION["userid"] <> "" && $_SESSION["userid"] <> $houseObj->userid)) {
...
?>
		...
		<input type="hidden" name="houseId" id="houseId" value="<?=$houseObj->HouseID?>" />
				...
				<tr>
					...
					<td>
						<input name="buildType" id="buildType" type="radio" value="1" class="chk" <?php if (($houseObj->BuildingTypeCode==1)) { print "checked"; } ?> checked tabindex="7" onFocus="checkLogin();" />
						<span class="r10">아파트</span>
						<input name="buildType" id="buildType" type="radio" value="2" class="chk" <?php if (($houseObj->BuildingTypeCode==2)) { print "checked"; } ?> onFocus="checkLogin();" />
						<span class="r10">빌라</span>
						<input name="buildType" id="buildType" type="radio" value="3" class="chk" <?php if (($houseObj->BuildingTypeCode==3)) { print "checked"; } ?> onFocus="checkLogin();" />
						<span class="r10">원룸</span>
						<input name="buildType" id="buildType" type="radio" value="4" class="chk" <?php if (($houseObj->BuildingTypeCode==4)) { print "checked"; } ?> onFocus="checkLogin();" />
