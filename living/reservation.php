				...
				<?php echo $houseObj->HouseName;?><br />(<?php echo $roomObj->RoomName;?>)
						...
						<td class="ltd">
							<ul class="intro">
								...
								<li><b>주소</b> : <a href="#" Onclick="javascript:window.open('../navermaps/a5.php?Naddr=<?php echo rawurlencode($houseObj->Address1." ".$houseObj->Address2);?>','win','top=0, left=500,width=550,height=450')"><?php echo $houseObj->Address1;?> <?php echo $houseObj->Address2;?></a></li>
