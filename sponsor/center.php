...
?>
			<tr>
				...
				<td>
					<input type="checkbox" name="chkCenter" id="chkCenter" value="<?php echo $requestInfo->RequestID;?>" class="chk"<?			 if (((!$supporter->IsNew()) && $supporter->Support($requestInfo->RequestID))) {
?> checked<?			 } ?> />
				</td>
<?php 
