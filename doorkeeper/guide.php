...
?>
		...
		<div id="content">
			<div class="tab">
				<ul>
					<li><a href="guide.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('tab_01','','/images/sub/tab_0101_on.gif',1)"><img src="/images/sub/tab_0101_on.gif" name="tab_01"></a></li>
