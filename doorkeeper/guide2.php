		...
		<div id="content">
			<div class="tab">
				<ul>
					...
					<li><a href="guide1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('tab_02','','/images/sub/tab_0102_on.gif',1)"><img src="/images/sub/tab_0102.gif" name="tab_02"></a></li>
					<li><a href="guide2.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('tab_03','','/images/sub/tab_0103_on.gif',1)"><img src="/images/sub/tab_0103_on.gif" name="tab_03"></a></li>
